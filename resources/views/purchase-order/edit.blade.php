            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('purchase-order.approve', $vendorOrder->id)}}" method="post">
                                @method('PUT')
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="vendor" name="vendor" value="{{$vendorOrder->vendor->names}}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="" class="col-sm-2 col-form-label">Phone</label>
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control" id="phone" name="phone" value="{{$vendorOrder->vendor->phone_number}}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="" class="col-sm-2 col-form-label">Email</label>
                                            <div class="col-sm-8">
                                                <input type="email" class="form-control" id="email" name="email" value="{{$vendorOrder->vendor->email}}" readonly>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="order-id" name="order-id" value="{{$vendorOrder->order_id}}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="" class="col-sm-2 col-form-label">Order Date</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="orderDate" name="orderDate" value="{{date('d/m/Y', strtotime($vendorOrder->created_at))}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            @forelse($purchases as $purchase)
                                                <tr>
                                                    ...
                                                    <td class="text-middle">{{$purchase->product->barcode}}</td>
                                                    <td class="text-middle"><img src="{{asset('storage/products/images/'.json_decode($purchase->product->images,true)[0])}}" width="100" alt="image"></td>
                                                    <td class="text-middle">{{$purchase->product->product_name}}</td>
                                                    <td class="text-middle">{{$purchase->product->category_id}}</td>
                                                    <td class="text-middle">{{$purchase->quantity}}</td>
                                                    <td class="text-middle">{{$purchase->product->unit}}</td>
                                                    <td class="text-middle">{{ number_format($purchase->product->purchase_price,0,'.',',') }} Rwf</td>
                                                    <td class="text-middle">{{number_format($purchase->amount,0,'.',',') }} Rwf</td>
                                                    @if($vendorOrder->order_status == 0)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-bold" colspan="2">{{number_format($vendorOrder->total_amount,0,'.',',')}} Rwf</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="row mt-2 mb-2">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        @elseif($vendorOrder->order_status == 1)
